...
public class AI_Nav_Movement_3 : MonoBehaviour
{
    // NavMesh
    ...
    [SerializeField] float TargetProbability = 0.2f;
    ConnectedPlayers CurrentPlayer;
    ConnectedPlayers LastPlayer;
        ...
        if (CurrentPlayer == null)
        {
            ...
            if (Players.Length > 0)
            {
                while (CurrentPlayer == null)
                {
                    ...
                    ConnectedPlayers StartingPlayer = Players[random].GetComponent<ConnectedPlayers>();
    ...
    private void FixedUpdate()
    {
        ...
        if (bAIMoving && navMeshAgent.remainingDistance <= 1.0f)
        {
            bAIMoving = false;
    ...
    private void SetDestination()
    {
        ...
        if (PlayersFound > 0)
        {
            ConnectedPlayers NextPlayer = CurrentPlayer.NextWaypoint(LastPlayer);
        ...
        //Vector3 targetVector = CurrentPlayer.transform.position;
